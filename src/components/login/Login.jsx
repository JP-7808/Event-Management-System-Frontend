...
const Login = () => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:6600/api/auth/login", credentials,{
  ...
  const handleGoogleLogin = () => {
    const redirectUri = "http://localhost:6600/api/auth/google/callback"; // Ensure this matches your backend
