    ...
    useEffect(() => {
        const fetchAttendees = async () => {
            try {
                ...
                const res = await axios.get(`https://event-management-system-backend-uela.onrender.com/api/events/${eventId}/attendees`, { withCredentials: true });
        ...
        const fetchEventTitle = async () => {
            try {
                ...
                const res = await axios.get(`https://event-management-system-backend-uela.onrender.com/api/events/${eventId}`);
